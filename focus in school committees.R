...
# Ekspert tilføjede ordene "nationale tests" (reduceret til nationale på 
# grund af fravær af n-grams), "prøver", samt "trivsel", som dog blev 
# droppet på grund af fokus på karakterer frem for trivsel
